...
public class ScreenBuilder{
	...
	public void addBTN(JPanel contentPane, JButton BTedit, JButton BTremove, JButton BTlist, JButton BTadd, JButton BTatthora, JButton UndoBTN, JButton RedoBTN, JButton BTponto, JButton BTtaxa, JButton BTvenda, JButton BTagenda, JButton BTfolha, JButton BTattdia){
	...
	public void addLBL(JPanel contentPane, JLabel texto, JLabel LBadd, JLabel LBremove, JLabel LBedit, JLabel LBlist, JLabel background, JLabel LBdata, JLabel LBhora, JLabel LBcartao, JLabel LBtaxa, JLabel LBagenda, JLabel LBvenda, JLabel label_1, JLabel LBfolha, JLabel LBsemana, JLabel LBur) {
